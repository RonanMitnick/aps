...
public class TelaRegistro extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(programaSocial.getSelectedItem().equals("Bolsa-Familia")){
            BeneficiarioBolsaCreche b1;
            b1 = new BeneficiarioBolsaCreche(jnome.getText(),jcpf.getText(),cnPessoas.getSelectedItem(), nfilhos.getSelectedItem(),jrenda.getText());
        }
